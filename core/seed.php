 ...
 *
 * Atomik: space + 14 kategori dalam satu transaksi. Transaction-aware --
 * kalau pemanggil sudah membuka transaksi (mis. registerUser), fungsi ini
 * menumpang transaksi itu (tidak begin/commit sendiri; commit/rollback jadi
 * keputusan pemanggil). Kalau dipanggil berdiri sendiri (mis. tambah ruang
 * usaha nanti), dia buka & tutup transaksinya sendiri.
 */
